...
- When updating files, use the command format: [[execute: update_file public/index.html]] followed immediately by the markdown content to be inserted.
-- [[execute: update_file /public/index.html]]\n\`\`\`markdown\n<html><body>Hello World</body></html>\n\`\`\`
- When including the style file in the HTML, use the following format: <link rel="stylesheet" type="text/css" href="styles.css" />
- Always verify file contents after updates using: [[execute: node -e "console.log(fs.readFileSync('public/index.html', 'utf8'));"]]
